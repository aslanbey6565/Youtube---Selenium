...
import java.time.Duration;
    ...
    //Mouse Actions Methods: 1) actions.moveToElement()
    //                       2) actions.click() , 3) actions.clickAndHold() , 4) actions.contextClick()
    //                       5) actions.doubleClick() 6)actions.dragAndDrop() - actions.dragAndDropby()


    //Klavye Actions Methods: 1) actions.sendKeys()   2)actions.keyDown   3)actions.keyUp


    //Actions Class Method Nasil Kullanilir;

    //1) Obje uretilir
    // Actions actions = new Actions(driver);

    //2) actions objesi ile kullanacagimiz webElementleri locate edin
    //3) Istenilen methodlari actions objesi ile kullanalim;
                 ...
                 //        .sendKeys(Keys.ENTER)
                 //        .perform();
    //3) sonuna perform() yazilmaz ise method calismaz
